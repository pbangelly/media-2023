...
const Apply = () => (
  ...
  <div className="bg-white">
    <div className="w-auto mx-auto text-center py-10 md:py-20 md:pr-10">
      <h2 className="text-3xl md:text-6xl font-extrabold text-red-800">
      ...
      <a
        ...
        // onClick={dataSubmit()}
        id="form_button"
        className="mt-8 w-auto inline-flex items-center justify-center px-5 py-3 border border-transparent text-2xl font-large rounded-lg text-white bg-red-800 hover:bg-green-500 hover:text-white sm:w-auto"
      >
        Reach Out
      </a>
    </div>
