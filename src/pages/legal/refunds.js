...
<Layout>
    <div className="py-5 px-10">
        ...
        <p>Thank you for shopping at Hack The Ratio.</p>
        ...
        <li>
        <p><strong>Website</strong> refers to Hack The Ratio, accessible from <a href="http://www.hacktheratio.org" rel="external nofollow noopener" target="_blank">http://www.hacktheratio.org</a></p>
        </li>
        <li>
