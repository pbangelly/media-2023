...
<div className="py-5 px-10">
    <h1 className="text-2xl text-bold py-5">Privacy Policy</h1>
    ...
    <h1 className="text-xl py-5">Collecting and Using Your Personal Data</h1>
    ...
    <h3 className="text-xl py-5">Usage Data</h3>
    ...
    <div className="py-5">
        <h3 className="text-md font-bold py-5">Information from Third-Party Social Media Services</h3>
    ...
    <h3 className="text-xl py-5">Law enforcement</h3>
    <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
    <h3 className="text-xl py-5">Other legal requirements</h3>
    ...
    <h2 className="text-xl py-5">Security of Your Personal Data</h2>
